...
Dear Fellow Students,
  ...
  We are going to organize a charity sale in the Students' Auditorium on December 21. On behalf of the Students' Union, I am writing to appeal to all students on campus to make a contribution.

  We hope you will donate your second-hand goods, which will be sold at bargain prices, and all the proceeds will go to support impoverished children's tuition fees. In addition, this fund-raising activity will last three days so that everyone can catch this opportunity to lend a hand. The reason we should do this is that young people in disadvantaged communities really need financial assistance to continue their studies.

  As college students, we should show our love by donating goods and money to make the world a fairer place. Please contribute generously.

<div style="text-align:right">Yours sincerely,<br>Li Ming</div>

> **素材修正记忆点**：`appeal to` / `make a contribution` / `at bargain prices` / `proceeds` / `lend a hand` / `contribute generously`。
> **格式**：每段前空2格，手写时 `Yours sincerely` 和 `Li Ming` 靠右。

## Day12 四步清单（40分钟）

- [ ] **1. 背 15分钟**：大声读3遍 → 盖住默写“活动信息—捐物用途—呼吁捐助”
- [ ] **2. 默 15分钟**：白纸完整默写一遍，控制在15分钟内
- [ ] **3. 改 5分钟**：错词抄5遍 → `charity / appeal / contribution / proceeds / impoverished`
- [ ] **4. 套 5分钟**：把 `charity sale` 换成 `low-carbon campaign`，把捐物换成关灯节电

**完成标准**：活动时间地点、捐助用途、呼吁三要素齐全，全文错词不超过2个，签名格式正确。
...
> [!NOTE]- Day12 答案&解析（做完再点开）
> **答案：** 31. A　32. B　33. C　34. C　35. A
>
> 1. **A**：第二段 `Their teams of engineers stayed on`，工程师被留用。
> 2. **B**：第三段 `chew up any innovative companies... putting an end to businesses that might one day turn into competitors`，扼杀潜在竞争对手。
> 3. **C**：第四段 `But are they good for the American economy? I don't know.`，担心损害国家经济。
> 4. **C**：第五段 `it asked... for information about their many small acquisitions`，调查小额收购。
> 5. **A**：第六段 `a drop in the ocean compared with their massive financial reserves`，九牛一毛，几乎无财务压力。
>
> **长难句：** `Their teams of engineers stayed on, making them two of the many "acqui-hires" that the biggest companies have used to feed their great hunger for tech talent.` → 工程师团队留了下来，成为大公司为满足人才饥渴而“收购式招聘”的众多案例之二。分词短语表结果。
>
> **核心词：** `buzz` 轰动 / `scrap` 废弃 / `remorseless` 无情的 / `chew up` 蚕食 / `seedling` 幼苗 / `mixed feelings` 复杂心情 / `wade into` 介入 / `a drop in the ocean` 九牛一毛
...
Dear Editors,
  ...
  To solve this problem, I would like to propose several practical recommendations as follows. First and foremost, it is imperative for us to raise public awareness of environmental protection through media campaigns. In addition, supermarkets and shops should be required to charge for plastic bags so as to discourage their excessive use. Last but not least, we should develop and promote environment-friendly alternatives.

  Thanks for your attention to this letter. I would be more than happy if you could take my suggestions into serious account.

<div style="text-align:right">Yours sincerely,<br>Li Ming</div>

> **素材修正记忆点**：`Regarding the issue of` / `of the utmost significance` / `it is imperative for us to` / `so as to` / `take... into serious account`。
> **格式**：每段前空2格，手写时 `Yours sincerely` 和 `Li Ming` 靠右。

## Day13 四步清单（40分钟）

- [ ] **1. 背 15分钟**：大声读3遍 → 盖住默写“表明观点—三条建议—盼采纳”
- [ ] **2. 默 15分钟**：白纸完整默写一遍，控制在15分钟内
- [ ] **3. 改 5分钟**：错词抄5遍 → `regarding / disposable / utmost / imperative / alternative`
- [ ] **4. 套 5分钟**：把 `disposable plastic bags` 换成 `food waste`，把建议换成光盘行动三条

**完成标准**：观点句 + 三条建议 + 盼采纳结尾齐全，全文错词不超过2个，签名格式正确。
...
> [!NOTE]- Day13 答案&解析（做完再点开）
> **答案：** 36. B　37. A　38. A　39. D　40. B
>
> 1. **B**：首段 `thin slicing` 研究 + 评分与学生期末评分高度相关，研究的是第一印象的可靠性。
> 2. **A**：第二段 `deliberation focused them on vivid but misleading cues`，写下理由（关注具体细节）后准确率大降。
> 3. **A**：第三段开车比喻 `if you start thinking about it too much, you can't remember what you're doing`，过度思考会干扰。
> 4. **D**：第四段 `asked to focus on their feelings rather than on details`，复杂决策跟着感觉走更好。
> 5. **B**：末段 `Use of their gut hurt their performance on the first four tasks`，直觉会损害反思类任务表现。
>
> **长难句：** `Ambady suspected that deliberation focused them on vivid but misleading cues, rather than letting the complex interplay of subtle signals form a holistic impression.` → 安巴迪认为，深思熟虑让他们聚焦于生动却误导的线索，而不是让微妙信号的复杂互动形成整体印象。
>
> **核心词：** `thin slicing` 薄片撷取 / `extraneous` 多余的 / `intrusive` 干扰的 / `correlate with` 与…相关 / `deliberation` 深思 / `holistic` 整体的 / `assuage` 缓解（2020已见） / `hunch` 预感
...
Dear Mr. President,
  ...
  I am writing to inform you that I intend to resign from my current position. The primary reasons for my resignation are as follows.

  First and foremost, as a young man whose primary interest is in fashion design rather than computer science, I have found that my present job does not match my academic background and personal strengths. What's more, I prefer to pursue other opportunities that may conform better to my educational background and personal interests.

  I am very grateful for the invaluable experience I have gained here. Thank you for the patience and generous assistance you rendered me during the past three years. Please accept my sincere apologies for any inconvenience my leaving may cause.

<div style="text-align:right">Yours sincerely,<br>Li Ming</div>

> **素材修正记忆点**：`inform you that I intend to resign` / `does not match` / `conform to` / `invaluable experience` / `render assistance`。
> **格式**：每段前空2格，手写时 `Yours sincerely` 和 `Li Ming` 靠右。

## Day14 四步清单（40分钟）

- [ ] **1. 背 15分钟**：大声读3遍 → 盖住默写“辞职告知—两条原因—感谢致歉”
- [ ] **2. 默 15分钟**：白纸完整默写一遍，控制在15分钟内
- [ ] **3. 改 5分钟**：错词抄5遍 → `resign / resignation / conform / invaluable / inconvenience`
- [ ] **4. 套 5分钟**：把 `fashion design` 换成 `teaching`，把 `computer science` 换成 `sales work`

**完成标准**：辞职告知、两条原因、感谢致歉齐全，全文错词不超过2个，签名格式正确。
...
25. John Brunnquell would disagree with Julie Stanton over regenerative products' ______.
    A. market prospects
...
> [!NOTE]- Day14 答案&解析（做完再点开）
> **答案：** 21. D　22. C　23. C　24. B　25. A
>
> 1. **D**：首段 `it's by design`，这种农场是专门设计的；第二段再生农业专项技术佐证。
> 2. **C**：第三段覆土作物引虫→鸡粪肥田→优质饲料循环，布朗兴奋的是可持续系统。
> 3. **C**：第四段有机鸡蛋从小众到沃尔玛，类比说明再生农产品也有市场潜力。
> 4. **B**：末段年轻人关心地球、愿为环保买单，会买气候友好鸡蛋。
> 5. **A**：Stanton 认为难卖（hard sell），Brunnquell 认为年轻人会改变食物链，分歧在市场前景。
>
> **长难句：** `Such improvements "allow our hens to forage for higher-quality natural feed that will be good for the land, the hens, and the eggs that we supply to our customers."` → 这些改进让母鸡觅得更优质的天然饲料，对土地、母鸡和供应给顾客的鸡蛋都有好处。
>
> **核心词：** `roam` 漫步 / `by design` 刻意设计 / `regenerative agriculture` 再生农业 / `forage` 觅食 / `niche` 小众的 / `open the floodgates` 打开大门 / `hard sell` 难卖 / `chalk up to` 归因于
...
What is illustrated in the column chart clearly shows that the business volume of express delivery in China changed greatly from 2018 to 2020. To be specific, the total volume surged from 51 billion pieces in 2018 to 83 billion pieces in 2020. When it comes to rural areas, the trend is particularly striking, with the volume doubling to 30 billion pieces in the last year alone.

There are many factors contributing to this phenomenon, but overall, they may be put down to the following two aspects. Initially, there is no doubt that with the rapid economic development in recent years, people's living standards have been improved remarkably, as a result of which, an increasing number of people are likely to shop online. At the same time, along with the prosperity of technology and the advancement of the Internet, online shopping has become more convenient, and improved logistics networks have extended courier services to vast rural markets.

Considering all these contributors, we should bear in mind that great importance should be attached to the healthy growth of express delivery. As far as I am concerned, it is a positive trend and should be stimulated, since it is conducive not merely to individuals but to the whole society.

- [ ] **背10分钟**：图表句填数字（51→83亿，农村30亿）→ 两条原因 → 积极评价
- [ ] **默10分钟**：盖住默写，数字不错、时态不错

> **模板对照记忆点**：第一段 `What is illustrated... + To be specific...` 只换主题和数字；第二段经济+科技两条万能原因；第三段 `Considering... + As far as I am concerned...` 积极表态。
...
Dear Mr. Smith,
  ...
  I have returned safely to my home in Shanghai, and I wish to thank you for everything you did for me. I really enjoyed my stay in the US.

  However, I regret to tell you that upon my arrival in Shanghai I suddenly discovered that I had left my bluetooth headset in your home. I am really sorry to trouble you further because of my carelessness, but I would really appreciate it if you could send it to me at your earliest convenience.

  Thanks again for your hospitality and care for me during my stay. If you ever have a chance to visit Shanghai, do not hesitate to let me know—I will make a good tour guide for you. I am looking forward to hearing from you soon.

<div style="text-align:right">Yours sincerely,<br>Li Ming</div>

> **素材修正记忆点**：`have returned safely to` / `I regret to tell you that` / `at your earliest convenience` / `hospitality` / `do not hesitate to let me know`。
> **格式**：每段前空2格，手写时 `Yours sincerely` 和 `Li Ming` 靠右。

## Day15 四步清单（40分钟）

- [ ] **1. 背 15分钟**：大声读3遍 → 盖住默写“感谢款待—遗落物品—请求寄回—回访邀请”
- [ ] **2. 默 15分钟**：白纸完整默写一遍，控制在15分钟内
- [ ] **3. 改 5分钟**：错词抄5遍 → `safely / regret / bluetooth / convenience / hospitality`
- [ ] **4. 套 5分钟**：把 `bluetooth headset` 换成 `camera`，把 `your home` 换成 `the hotel`

**完成标准**：失物名称地点、请求寄回、回访邀请齐全，全文错词不超过2个，签名格式正确。
...
29. Many "unretirees" are increasing their savings by ______.
...
> [!NOTE]- Day15 答案&解析（做完再点开）
> **答案：** 26. D　27. A　28. C　29. D　30. A
>
> 1. **D**：第二段三分之一计划退而不休、超半数有钱也愿意工作，趋势明确。
> 2. **A**：第三段退休后要防无聊、防抑郁、保心理健康，反推退休可能带来这些问题。
> 3. **C**：第五段 `Americans are living longer`，长寿是模式变化的部分原因。
> 4. **D**：第六段 `reducing their overall expenses`，少花钱是最常用的增储办法。
> 5. **A**：末段 `Many people believe they can't retire` + 建议咨询顾问，说明多数人没准备好。
>
> **长难句：** `Even more surprising is that more than half of "unretirees"—those who plan to work in retirement or went back to work after retiring—said they would be employed in their later years even if they had enough money to settle down.` → 更惊人的是，超半数“退而不休”者说即便钱够养老也愿意晚年工作。破折号内是定义。
>
> **核心词：** `opt to` 选择 / `upend` 颠覆 / `culprit` 起因 / `fulfillment` 满足感 / `evolve` 演变 / `nest egg` 储备金 / `make ends meet` 维持生计 / `preretiree` 准退休者
...
Dear International Students,
  ...
  There will be a multicultural food festival at the Main Dining Hall from 10 a.m. to 3 p.m. on May 27th. You are cordially invited to attend this occasion.

  The event features a variety of local specialties, ranging from traditional homely delicacies to popular street snacks, all elaborately prepared by our catering staff. If interested, you are also encouraged to cook your hometown dishes in groups with the ingredients provided on site. After preparation, all participants can move along the booths, sampling these delicious foods with cheerful music.

  Don't miss this golden opportunity to get a taste of different cultures. We are looking forward to your participation.

<div style="text-align:right">Yours sincerely,<br>Li Ming</div>

- [ ] **背10分钟**：时间地点（5月27日食堂）→ 活动内容（品尝+自制家乡菜）→ 盼参加
- [ ] **默10分钟**：盖住默写，时间地点数字不错

> **模板对照记忆点**：邀请信首段 `I am writing to invite you to...` / 中段两点论 / 尾段 `looking forward to your participation`。
...
What is illustrated in the bar chart clearly shows that residents in a certain city prefer different ways of taking exercise. To be specific, exercising alone accounts for the largest proportion at over half, followed by exercising with friends at 47.7% and with family members at 23.9%. At the bottom, no more than 16% of those questioned take part in team sports.

There are many factors contributing to this phenomenon, but overall, they may be put down to the following two aspects. Initially, there is no doubt that with the rapid development of modern society, people's pace of life has quickened remarkably, as a result of which, exercising alone is more flexible and convenient. At the same time, along with the prosperity of technology and the advancement of the Internet, a wide range of fitness videos and apps have made working out alone at home easier than ever.

Considering all these contributors, we should bear in mind that great importance should be attached to physical exercise in whatever form. Communities should provide more accessible facilities, so that residents can enjoy both health and friendship.

- [ ] **背10分钟**：数据句（超半数/47.7%/23.9%/16%）→ 快节奏+科技两条原因 → 社区建议
- [ ] **默10分钟**：盖住默写，四个数字不错、顺序不错

> **模板对照记忆点**：同一套模板，Day14填的是快递数据，今天填的是锻炼数据——考场上只换主题词和数字，骨架不动。
...
- [ ] **翻25分钟**：按句子逐句翻，划出定语从句（`that we didn't expect` / `that they might not want to talk to us`）先断句再连词
- [ ] **对15分钟**：对照折叠区参考译文，用红笔标出漏翻、错翻的关键词

> [!NOTE]- Day17 参考译文（翻完再点开）
> 我们往往认为，朋友和家人是我们获得情感归属、欢乐和温暖的最主要来源。虽然这很有可能正确，但是，研究人员最近也发现，与陌生人交流实际上会给我们带来意料之外的好心情以及归属感。
>
...
>
> **得分关键词**：`tend to` 往往 / `boost` 提升 / `instruct` 指示 / `strike up` 搭讪 / `shy away from` 回避 / `misplaced` 不必要的 / `flattered` 感到荣幸
>
> **难句拆解**：`researchers have also recently found that interacting with strangers actually brings a boost in mood and feelings of belonging that we didn't expect.` → 主句+宾语从句+定语从句（that从句修饰mood and feelings），先翻主干“研究发现交流带来好心情和归属感”，再补“意料之外的”。

---

## Day17 本周错词复盘（20分钟）

- [ ] 把 Day12—Day16 五天四步清单里抄过5遍的错词拿出来，盖住中文默英文
- [ ] 默错的词再抄5遍：`appeal / contribution / disposable / imperative / resign / conform / bluetooth / hospitality / unretiree / fulfillment`
- [ ] 大作文模板挖空默一遍（只默骨架，不填数据）：
```text
...
> **今天1小时：7天小作文快速默写 + 大作文模板默写 + 7篇阅读错题整理。不学新内容。**

## 一、7天小作文快速默写（30分钟）

- [ ] Day12 倡议信：`appeal to` / `make a contribution` / `at bargain prices`
- [ ] Day13 致编辑信：`Regarding the issue of` / `of the utmost significance` / `take... into serious account`
- [ ] Day14 辞职信：`intend to resign` / `conform to` / `invaluable experience`
- [ ] Day15 寻找失物信：`I regret to tell you that` / `at your earliest convenience` / `hospitality`
- [ ] Day16 美食节邮件：时间地点（5月27日食堂）+ `cordially invited` + `looking forward to your participation`
- [ ] 大作文模板：Day14（快递51→83亿/农村30亿）+ Day16（锻炼超半数/47.7%/23.9%/16%）各默数据句一遍
- [ ] Day17 翻译关键词：`tend to / boost / strike up / shy away from / flattered`

**复盘必背句**：

```text
On behalf of the Students' Union, I am writing to appeal to...
Regarding the issue of..., it is my view that...
I am writing to inform you that I intend to resign from...
I regret to tell you that upon my arrival..., I discovered that...
You are cordially invited to attend...
What is illustrated in the chart clearly shows that...
To be specific, ... accounts for the largest proportion at...%.
```

## 二、7篇阅读+翻译错题整理（30分钟）

- [ ] 统计 Day12—Day16 的错题类型：细节 / 推理 / 例证 / 主旨 / 态度 / 词汇
- [ ] 翻译对照：标出自己漏翻的定语从句和关键词，抄3个最难的句子重翻一遍
- [ ] 把最常错的10个词整理到错词本
- [ ] 每篇抄1个定位句，标出题干关键词是如何在原文同义替换的

> [!NOTE]- Day18 复盘检查（做完再点开）
> **作文检查：**
> 1. 倡议信 `appeal to`、辞职信 `intend to resign`、失物信 `at your earliest convenience` 搭配0错。
> 2. 致编辑信观点句 + 三条建议；美食节邮件时间地点数字不错。
> 3. 大作文两套数据（快递 / 锻炼）都能在同一模板里默出，数字不错、顺序不错。
> 4. 每封能在15分钟内默完，错词不超过2个。
>
> **阅读检查：**
> - 2021—2022均使用英语（二）真题；不要用普通英语阅读或自编文章替代。
