...
> **今天1小时20分：2025年英语二 Text 3 + 大作文五套数据总默。Day31 NHS记得睡前30秒回顾。**
...
> [!NOTE]- Day33 答案&解析（做完再点开）
> **答案：** 31. A　32. B　33. A　34. B　35. D
>
> 1. **A**：首段清凉病房+酷热停工，措施针对极端高温天气。
> 2. **B**：第二段 `triggering thresholds often are not customized to the local climate`，缺本地化预警标准。
> 3. **A**：第三段 36°C未达阈值却致死，主因湿度+缺遮阴，预警需纳入温度之外因素。
> 4. **B**：第五段 `tell officials which neighborhoods to focus on`，地图帮锁定重点区域。
> 5. **D**：末段 `not just... emergency responses, but also... medium- to long-term measures`，预案应服务更广目标。
>
> **长难句：** `But the effects of the heat were amplified by humidity — an often neglected factor in heat alert systems — and the lack of shade at the late-morning outdoor ceremony.` → 高温危害被湿度和缺遮阴放大。破折号内补充“常被忽视的因素”。
>
> **核心词：** `proliferate` 激增 / `spell out` 阐明 / `uneven` 参差不齐的 / `threshold` 阈值 / `customize to` 按…定制 / `nuanced` 细微的 / `amplify` 放大 / `retrofit` 翻新改造

---

## Day33 大作文五套数据总默（20分钟）
...
> **今天1小时：2025年英语二 Text 4 + 翻译七篇关键词总默。Day33高温预案记得睡前30秒回顾。**
...
> [!NOTE]- Day34 答案&解析（做完再点开）
> **答案：** 36. C　37. D　38. A　39. D　40. D
>
> 1. **C**：首段 `shared shortcuts` + `go from point A to point B most effectively`，追求便利高效。
> 2. **D**：第二段学生自由走、学校随后铺路成网，积极接纳心选小路。
> 3. **A**：第三段小路照片配“走指定步道”牌子，反映用与禁的对立观点。
> 4. **D**：第四段小径被拓宽成商路再成百老汇，说明心选小路被官方认可吸纳。
> 5. **D**：末段鸭群狗群也有小路，人与动物共享“走捷径”特性。
>
> **长难句：** `Urban planners interpret desire paths as more than just convenient shortcuts; they offer valuable insights into the dynamics between planning and behaviour.` → 规划者视心选小路不止是捷径，更是窥见规划与行为互动的窗口。分号连接阐释句。
>
> **核心词：** `desire path` 心选小路 / `trodden` 踩出的 / `bisect` 横切 / `aesthetics` 美学 / `adhere to` 遵守 / `curated` 精心打造的 / `defy` 违抗 / `criss-cross` 交错

---

## Day34 翻译七篇关键词总默（20分钟）

- [ ] 七篇翻译关键词盖住中文默英文：陌生人（`strike up / shy away from / flattered`）、诗歌（`celebrate / pass down / come to life`）、绘画（`come up with / think outside the box / second nature`）、失败（`be up to / keep from / otherwise`）、海里厄特（`contrary to / have a go at / earn... the hard way`）、农贸市场（`burst with / cut out the middleman / secure profit`）、谈话停顿（`dip / connected / reflection and expression`）
- [ ] 默错的词抄5遍
- [ ] 每篇重翻1个最难的句子（共7句）
...
> **今天2小时：2019年英语二 Part A 小作文 + 大作文 + 翻译，完整限时写一遍。不对答案，只计时交卷。**

## Day35 模考任务（120分钟，严格计时）

- [ ] **小作文 30分钟**：2019年真题（给Smith教授写邮件：为城市交通辩论赛建议辩题+告知安排——建议类，用建议信模板独立写）
- [ ] **大作文 40分钟**：2022年快递柱状图（51→83亿/农村30亿），盖住范文独立写
- [ ] **翻译 40分钟**：2019年海里厄特，盖住译文独立翻
- [ ] **剩余10分钟**：检查三处——小作文辩题+安排两点全不全、大作文数字不错、翻译定语从句不断句

> **交卷标准**：时间到就停笔，标出没写完的地方。错词、漏句留到Day36订正，今天不查书。

**2019小作文题干（真题原文，供模考用）：**
Suppose Professor Smith asked you to plan a debate on the theme of city traffic. Write him an email to 1) suggest a specific topic with your reasons, and 2) tell him about your arrangements. About 100 words.

**2022大作文图表（真题数据，供模考用）：**
柱状图：2018—2020全国快递51亿→83亿件，农村翻番至300亿件。150词。
...
> **今天1小时：Day35三篇逐篇订正 + 错词入库。Day34心选小路记得睡前30秒回顾。**

## Day36 订正清单（60分钟）

- [ ] **小作文 15分钟**：对照建议信模板（Day1/Day19），查辩题+理由+安排三点；`I suggest making... / I will be waiting for your response` 搭配
- [ ] **大作文 20分钟**：对照Day14快递范文，查数字（51/83/30亿）、时态（过去时）、模板骨架三处
- [ ] **翻译 15分钟**：对照Day26海里厄特译文，查漏翻关键词 + 长句断句
- [ ] **错词入库 10分钟**：三篇所有错词抄5遍，进错词本；标出重复错（以前也错过的词画★）

> [!NOTE]- Day36 订正标准（做完再点开）
> **过关线：**
> 1. 小作文15分钟内能重默一遍，错词≤2个。
> 2. 大作文数字全对，模板骨架0错。
> 3. 翻译关键词无漏翻，最难1句能独立重翻。
> 4. ★词（重复错）单独成页，考前只看这页。
...
> **今天2小时：2024年英语二 Part A 小作文 + 大作文 + 翻译，完整限时写一遍。不对答案，只计时交卷。**

## Day37 模考任务（120分钟，严格计时）

- [ ] **小作文 30分钟**：2024年真题（古镇老宅调查计划邮件——Day28背过，今天盖住范文独立写）
- [ ] **大作文 40分钟**：2024年劳动实践课柱状图（91.3%/84.8%/54.4%/32.6%），盖住范文独立写
- [ ] **翻译 40分钟**：2024年农贸市场，盖住译文独立翻
- [ ] **剩余10分钟**：检查三处——小作文计划三点全不全、大作文四数据顺序对不对、翻译伴随状语漏没漏

> **交卷标准**：时间到就停笔，标出没写完的地方。留到Day38订正，今天不查书。

---

# 考研英语范文 - Day38 模考订正日

> **今天1小时：Day37三篇逐篇订正 + 两次模考对比。**

## Day38 订正清单（60分钟）

- [ ] **小作文 15分钟**：对照Day28古镇邮件范文，查 `outline my plan / field investigation / hear your thoughts`
- [ ] **大作文 20分钟**：对照Day27劳动范文，查四数据（91.3/84.8/54.4/32.6）+ `while only a minority...` 句
- [ ] **翻译 15分钟**：对照Day29农贸市场译文，查 `burst with / pick up / cut out` 僻义
- [ ] **两次对比 10分钟**：Day35 vs Day37——哪类错得少了（小作文/大作文/翻译），哪类还是★重灾区

> [!NOTE]- Day38 订正标准（做完再点开）
> **过关线：**
> 1. 两次模考小作文都能15分钟内重默，错词≤2个。
> 2. 大作文两套数据（快递/劳动）数字全对。
> 3. 翻译两篇关键词无漏翻。
> 4. 写出一句考前提醒（例如“大作文先写数字句”“翻译先划主干”），贴在错词本首页。

---

# 考研英语范文 - Day39 总复盘日

> **今天1小时：2019–2025全体系过一遍。不学新内容，考前按这份清单查漏。**

## 一、大作文终默（20分钟）

- [ ] 模板骨架默一遍，0错
- [ ] 五套数据句各默一遍：快递 / 锻炼 / 健康 / 劳动 / 休闲
- [ ] 折线图拐点句 `marked a watershed` + 四数据句 `while only a minority...` + 五数据句 `In contrast... respectively` 各默一遍

## 二、翻译终默（20分钟）

- [ ] 七篇关键词全默一遍：陌生人 / 诗歌 / 绘画 / 失败 / 海里厄特 / 农贸市场 / 谈话停顿
- [ ] 每篇最难1句重翻一遍（共7句）

## 三、阅读终查（20分钟）

- [ ] 28篇答案速览一遍（Day3—Day34各折叠区答案行），标出曾经做错的题号
- [ ] 错题类型终统计：细节 / 推理 / 例证 / 主旨 / 态度 / 词汇——哪类最多，考场先做哪类、后做哪类
- [ ] ★词页读三遍

> [!NOTE]- Day39 终检（做完再点开）
> **考场三句话：**
> 1. 小作文先写身份目的，再两点论，最后寒暄+签名靠右。
> 2. 大作文先抄数字句（对照图表一个一个抄），再套两条原因，最后积极/消极表态。
> 3. 翻译先划主干（主谓宾），定语从句断开另起一句，关键词一个不漏。
>
> **全部完成标准：**
> - [ ] 模板骨架0错，五套数据数字全对
> - [ ] 七篇翻译关键词无漏
...
- [ ] 阅读28篇：2019-T1/T2/T3/T4、2020-T1/T2/T3/T4、2021-T1/T2/T3/T4、2022-T1/T2/T3/T4、2023-T1/T2/T3/T4、2024-T1/T2/T3/T4、2025-T1/T2/T3/T4（其中2020-T1机器鼠、2021-T1再培训见Day40补课文件）
- [ ] 大作文5套数据：2022快递 / 2021锻炼 / 2023健康 / 2024劳动 / 2025休闲
- [ ] 翻译7篇：2019海里厄特 / 2020失败 / 2021陌生人 / 2022绘画 / 2023诗歌 / 2024农贸市场 / 2025谈话停顿
- [ ] 小作文：15种类型范文在素材+Day05–Day18文件中，真题变体在Day16/24/28/31
