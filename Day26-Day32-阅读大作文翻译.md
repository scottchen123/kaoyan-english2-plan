...
> **今天1小时20分：2024年英语二 Text 1 + 2019年翻译（海里厄特）。Day24青少年矛盾记得睡前30秒回顾。**
...
> [!NOTE]- Day26 答案&解析（做完再点开）
> **答案：** 21. C　22. C　23. D　24. A　25. D
>
> 1. **C**：首段 `the gains will have to be more evenly shared`，收益须更公平分享。
> 2. **C**：第二段 `use of digital technologies to boost productivity`，用来提高生产率即工作效率。
> 3. **D**：第三段 `tech's inequality problem could be a roadblock to deploying AI` + `you need social buy-in`，怕公众不接受。
> 4. **A**：第五段 8城占38%科技岗位、15城占三分之二AI资产，说明分布不均。
> 5. **D**：末段 `conceive of AI technologies that don't simply replace jobs but expand opportunities`，重新定义AI角色（创造机会而非替代）。
>
> **长难句：** `"An economy of tech millionaires or billionaires and gig workers, with middle-income jobs undercut by automation, will not be politically sustainable."` → 一个由科技富豪和零工组成、中产岗位被自动化侵蚀的经济，在政治上不可持续。with短语表伴随。
>
> **核心词：** `undercut` 侵蚀 / `sustainable` 可持续的 / `buy-in` 认同 / `simmering` 暗涌的 / `disparity` 差距 / `soar` 飙升 / `stranglehold` 扼制 / `conceive of` 构想
...
- [ ] **翻25分钟**：逐句翻，`contrary to / have a go at / earn... the hard way` 三个搭配别翻错；末句 `Everything... no exception` 绝对表达别漏
- [ ] **对15分钟**：对照折叠区参考译文，用红笔标出漏翻、错翻的关键词

> [!NOTE]- Day26 参考译文（翻完再点开）
...
>
> **得分关键词**：`underestimate` 低估 / `readable` 易读的 / `imitate` 模仿 / `contrary to` 与…相反 / `have a go at` 尝试 / `abundance` 充裕 / `polished` 精湛的 / `along the way` 一路上 / `earn... the hard way` 来之不易
>
> **难句拆解**：`While he obviously had an abundance of natural talent, the final, polished work that he gave to the world was the result of years of practicing, re-writing and reading.` → While让步“虽然天分高”，主句“精湛作品是多年练习的结果”，定语从句 that he gave to the world 修饰 work，先翻主干再补定语。

---

# 考研英语范文 - Day27 今日任务

> **今天1小时20分：2024年英语二 Text 2 + 2024年大作文（劳动实践课）。Day26数字经济记得睡前30秒回顾。**
...
> [!NOTE]- Day27 答案&解析（做完再点开）
> **答案：** 26. A　27. A　28. B　29. D　30. C
>
> 1. **A**：首段 `only 20 per cent... is home-grown` + `reduce reliance on imports`，需增加国内供应。
> 2. **A**：第二段 `don't go far enough`，新激励远远不够、解决不了建筑危机。
> 3. **B**：第二段 `not taken responsibility for investing in our domestic wood supply, leaving us exposed to fluctuating prices`，缺投资致价格波动暴露。
> 4. **D**：第三段 `hesitation on behalf of farmers... to invest in longer-term planting`，农户不愿种树。
> 5. **C**：第四段 `we need our land to also provide secure supplies of wood`，政府应支持生产性植树。
>
> **长难句：** `"For decades we have not taken responsibility for investing in our domestic wood supply, leaving us exposed to fluctuating prices and fighting for future supplies of wood as global demand rises and our own supplies fall."` → 几十年来我们没投资国内木材供应，导致价格波动暴露、未来抢木。现在分词表结果，as表原因。
>
> **核心词：** `timber` 木材 / `reliance` 依赖 / `fluctuating` 波动的 / `decimation` 大批毁灭 / `hesitation` 犹豫 / `rewilding` 野化 / `impetus` 动力 / `aspiration` 愿望
...
What is illustrated in the bar chart clearly shows the major gains students have obtained from a practical course at a certain university. To be specific, acquiring relevant knowledge accounts for the largest proportion at 91.3%, followed by honing hands-on skills at 84.8%. In addition, a considerable 54.4% reported a boost in well-being, while only a minority of 32.6% felt their teamwork abilities improved.

There are many factors contributing to this phenomenon, but overall, they may be put down to the following two aspects. Initially, there is no doubt that with the rapid development of education in recent years, courses focusing on individual competencies have improved remarkably, as a result of which, students can easily acquire knowledge and skills. At the same time, along with changes in teaching methods, practical courses provide students with real experience, which should be taken into account.

Considering all these contributors, we should bear in mind that great importance should be attached to teamwork education as well. Colleges should integrate more group projects, so that students can enjoy both knowledge and cooperation. Only in this way can education become more comprehensive and meaningful.

- [ ] **背10分钟**：四档数据（91.3%/84.8%/54.4%/32.6%）→ 个人能力+教学方法两条原因 → 补团队合作短板
- [ ] **默10分钟**：盖住默写，四个数字不错、顺序不错

> **模板对照记忆点**：四数据专用 `the largest... followed by... In addition... while only a minority...`；这篇的第三段不是纯表扬而是“补短板”，考场遇到“有高有低”的图照此写。

---

# 考研英语范文 - Day28 今日任务

> **今天1小时20分：2024年英语二 Text 3 + 2024年小作文真题（古镇老宅调查邮件）。Day27木材危机记得睡前30秒回顾。**
...
> [!NOTE]- Day28 答案&解析（做完再点开）
> **答案：** 31. C　32. D　33. B　34. B　35. B
>
> 1. **C**：首句 `One of the biggest challenges`，让高龄危险驾驶员交钥匙是艰巨任务。
> 2. **D**：第二段各州做法不一（require / allow but not mandate / breach），反响各异。
> 3. **B**：第三段 `addressed piecemeal by different professions`，各管一摊，需统筹协调。
> 4. **B**：第五段 `can't... remember where they are going`，记性差是开车困难原因之一。
> 5. **B**：末段 `we need cars that a 90-year-old can drive comfortably`，开发适老汽车。
>
> **长难句：** `Mandatory in-person renewal was associated with a 31 per cent reduction in fatal crashes involving drivers 85 or older.` → 强制现场换证使85岁以上驾驶员致命事故下降31%。`be associated with` 相关，主语长、谓语短。
>
> **核心词：** `turn over the keys` 交钥匙 / `impairment` 损伤 / `mandate` 强制 / `breach of confidentiality` 泄密 / `piecemeal` 零散的 / `gerontologist` 老年学家 / `mandatory` 强制的 / `algorithm` 算法
...
Dear Jack,
  ...
  We could start by using online archives to find out about the history of these old houses before conducting a field investigation to document their current condition with photos. During our visit, we could interview a random sample of local residents and tourists, whose views may be a useful guideline for raising public awareness. Furthermore, it would be essential to ask experts to share their insights into how to tackle the challenges of heritage building protection.

  This is my preliminary plan. I would like to hear your thoughts, particularly on what questions to ask during interviews. Please feel free to share your feedback anytime.

<div style="text-align:right">Yours sincerely,<br>Li Ming</div>

- [ ] **背10分钟**：背景（期待调查）→ 计划三点（查档案+实地拍照+采访居民游客+请教专家）→ 征求意见
- [ ] **默10分钟**：盖住默写，`outline my plan / field investigation / hear your thoughts` 0错

> **模板对照记忆点**：计划类邮件骨架 `outline my plan / We could... Furthermore... / hear your thoughts`；征求意见结尾 `Please feel free to share your feedback` 通用。

---

# 考研英语范文 - Day29 今日任务

> **今天1小时20分：2024年英语二 Text 4 + 2024年翻译（农贸市场）。Day28高龄驾驶记得睡前30秒回顾。**
...
> [!NOTE]- Day29 答案&解析（做完再点开）
> **答案：** 36. A　37. A　38. D　39. B　40. D
>
> 1. **A**：首段 35万款、2020年新增9万款，说明健康App盛行。
> 2. **A**：第二段现行法只管医院诊所保险公司，App数据不受同等保护，覆盖面需扩大。
> 3. **D**：第三段和解令要求 `get app users' express affirmative consent`，须获用户明确同意。
> 4. **B**：第四段 `the rate at which these health apps are hitting the market demonstrates... immense challenge`，新App井喷是挑战。
> 5. **D**：末段加州/弗吉尼亚/科罗拉多/犹他已立法，部分州已有立法支持。
>
> **长难句：** `Flo Health and the FTC settled the matter with a Consent Order requiring the company to get app users' express affirmative consent before sharing their health information.` → 和解令要求公司分享前须获用户明确同意。分词短语 requiring... 修饰 Order。
>
> **核心词：** `prevalence` 盛行 / `safeguard` 保护 / `monetize` 变现 / `alleged` 指控 / `affirmative consent` 明确同意 / `empower` 授权 / `after the fact` 事后 / `shore up` 加强
...
- [ ] **翻25分钟**：逐句翻，首句三个伴随状语（smell / stalls / buzz）别漏；`pick up` 取“买到”僻义；`cut out` 取“省去”义
- [ ] **对15分钟**：对照折叠区参考译文，用红笔标出漏翻、错翻的关键词

> [!NOTE]- Day29 参考译文（翻完再点开）
> 空气中弥漫着咖啡和新鲜面包的香味，摊位上摆满了五颜六色的蔬菜和令人垂涎的奶酪，友好的交谈声嘈杂而又喧闹着，农贸市场就是一场感官盛宴。它们还提供了一个机会，让人们既能与提供食物的种植者和养殖者交谈，又能支持地方经济，同时还能买到新鲜的时令农产品。
>
> 农贸市场通常是每周或每月举行一次的活动，其中最常见的是户外摊位，这使得农民或生产者能够将他们的食物直接售卖给顾客。农贸市场的规模或规律因季节而异，这取决于当地的农业日历，你很可能会发现在一年中的不同时间会有不同的农产品在出售。通过省去中间商环节，农民可以从自己的农产品中获取更多的利润。顾客也能从中受益，因为他们能够清楚地看见自己的钱花在了哪里、付给了谁。
>
> **得分关键词**：`burst with` 摆满 / `a feast for the senses` 感官盛宴 / `responsible for` 负责…的 / `seasonal produce` 时令农产品 / `cut out the middleman` 省去中间商 / `secure profit` 获取利润
>
> **难句拆解**：`With the smell..., stalls..., and the buzz..., farmers' markets are a feast for the senses.` → 三个 with/独立主格伴随状语铺陈感官（嗅/视/听），主句收束“一场感官盛宴”；`They also provide an opportunity to talk..., support... and pick up...—all at the same time.` → 三个并列不定式（交谈/支持/买到），`all at the same time` 融入句中翻“同时”。

---

# 考研英语范文 - Day30 今日任务

> **今天1小时20分：2025年英语二 Text 1 + 2025年大作文（老年人休闲）。Day29健康App记得睡前30秒回顾。**
...
> [!NOTE]- Day30 答案&解析（做完再点开）
> **答案：** 21. B　22. C　23. A　24. D　25. A
>
> 1. **B**：首段 `earning most of their income via tips`，小费是服务员主要收入来源，不可或缺。
> 2. **C**：第二段 `not connected to the salary and service norms` + 末段 `completely dissociated from service quality`，今昔差异在是否挂钩服务质量。
> 3. **A**：第四段 `The prevalence of digital payment devices has made it easier`，数字支付助长蔓延。
> 4. **D**：第六段 `To ensure that all employees were paid fair wages`，为保证所有员工公平收入。
> 5. **A**：末段 `customers are frustrated... asked for too high of a tip too often`，小费成顾客负担。
>
> **长难句：** `And, as our research emphasizes, tipping now seems to be more coercive, less generous, and often completely dissociated from service quality.` → 如今小费更强制、更少慷慨、常与服务质量脱钩。三个并列表语，插入语表研究强调。
>
> **核心词：** `historically` 历史上 / `prompt` 提示 / `norm` 规范 / `beforehand` 预先 / `creep into` 蔓延进 / `tipflation` 小费通胀 / `fizzle out`不了了之 / `coercive` 强制的 / `dissociated` 脱离的
...
The given bar chart depicts the primary leisure activities of the elderly in a certain community. To be specific, those who choose to watch television make up the largest proportion at 90.8%, and those who choose to take walks come second at 68.3%. In contrast, those who favor planting flowers, reading and playing chess occupy smaller shares: 34.7%, 31.8% and 18.4% respectively.

There are many factors contributing to this phenomenon, but overall, they may be put down to the following two aspects. Initially, there is no doubt that with the improvement of living standards in recent years, the elderly have more free time and better material conditions, as a result of which, watching television becomes an extremely convenient way to access information and entertainment. At the same time, along with the advancement of medical care and health awareness, walking as a low-intensity outdoor activity suits many of the elderly.

Considering all these contributors, we should bear in mind that great importance should be attached to diverse leisure activities. The elderly are advised to try more forms of leisure besides the current ones, so as to bring more color to their lives. Only in this way can their later years become more colorful and meaningful.

- [ ] **背10分钟**：五档数据（90.8%/68.3%/34.7%/31.8%/18.4%）→ 方便+健康两条原因 → 多元化建议
- [ ] **默10分钟**：盖住默写，五个数字不错、顺序不错

> **模板对照记忆点**：五数据专用 `the largest... come second... In contrast... respectively`；五套数据（快递/锻炼/健康/劳动/休闲）同一骨架全通。

---

# 考研英语范文 - Day31 今日任务

> **今天1小时40分：2025年英语二 Text 2 + 2025年翻译（谈话停顿）+ 2025年小作文真题（短剧邀请邮件）。Day30小费文化记得睡前30秒回顾。**
...
29. To maximise the nation's health, the author suggests ______.
...
> [!NOTE]- Day31 答案&解析（做完再点开）
> **答案：** 26. B　27. C　28. C　29. B　30. C
>
> 1. **B**：第二段等候名单680万+看病难+积压其他公共服务，难满足需求。
> 2. **C**：第三段 `Much more needs to be invested in communities and primary care`，加大基层投入。
> 3. **C**：第四段 `urgent rethink of the hospital-centric model`，重构以医院为中心的体系。
> 4. **B**：第五段 `healthcare accounts for only about 20%... Much more important are the places we live, work and socialise`，重视社会因素。
> 5. **C**：末段 `what should be given to local leaders`，地方领导应发挥更大作用。
>
> **长难句：** `It is estimated, for example, that healthcare accounts for only about 20% of health outcomes.` → 据估计，医疗只占健康结果的约20%。形式主语 it + 宾语从句。
>
> **核心词：** `visionary` 有远见的 / `lag behind` 落后 / `waitlist` 等候名单 / `acute` 严重的 / `divert` 转移 / `hospital-centric` 以医院为中心的 / `scrap` 废弃 / `hefty` 沉重的
...
- [ ] **翻25分钟**：逐句翻，`so... that...` 程度状语别漏；陌生人vs朋友的对比（dip vs increased）别翻反
- [ ] **对15分钟**：对照折叠区参考译文，用红笔标出漏翻、错翻的关键词

> [!NOTE]- Day31 参考译文（翻完再点开）
> 你知道那种时刻吧——谈话慢了下来，然后出现了停顿。这种场面令人尴尬，尴尬到让一些人惊慌失措，只能随便说些什么。我们都认为这样的沉默让人倍感压力吗？
>
...
>
> **得分关键词**：`pause / gap` 停顿 / `panic` 惊慌 / `frequency and impact` 发生率及影响 / `overview` 综述 / `connected` 亲密的 / `dip` 下降 / `reflection and expression` 思考和表达
>
> **难句拆解**：`including an overview of previous studies which indicate that the fear of awkward silences can be so extreme that people avoid talking to strangers, even though doing so is likely to be an enjoyable experience.` → including含先前研究综述+which定语从句（so... that... + even though让步），先翻主干“回顾了综述”，再补“怕尴尬→避交谈→虽愉快”的三层逻辑。
...
Dear John,
  ...
  I'm currently planning a short play adapted from The Romance of the Three Kingdoms. I'm writing to invite you to act in the play.

  The play will start filming on December 30th. It will show the great stories of strategy, loyalty and heroism from this classic Chinese novel. It not only has attractive plots and rich characters, but also provides a great opportunity to explore Chinese culture. Considering your love for Chinese culture, I believe your excellent acting skills and passion for the arts will make the plot vivid.

  I would appreciate it if you could join us. Look forward to your early reply.

<div style="text-align:right">Yours sincerely,<br>Li Ming</div>

- [ ] **背10分钟**：剧目（三国演义）→ 开拍时间（12月30日）→ 邀请理由（爱中国文化+演技好）→ 盼复
- [ ] **默10分钟**：盖住默写，`adapted from / start filming on / Look forward to` 0错

> **模板对照记忆点**：邀请信骨架 `I'm writing to invite you to... / Considering... / Look forward to your early reply`；把短剧换成讲座/美食节照样套。

---

# 考研英语范文 - Day32 复盘日

> **今天1小时：大作文五套数据默写 + 翻译关键词复盘 + 7篇阅读错题整理。不学新内容，无小作文。**

## 一、大作文+翻译复盘（30分钟）

- [ ] 大作文模板骨架默一遍（挖空版）
- [ ] 五套数据句各默一遍：快递（51→83亿/农村30亿）、锻炼（超半数/47.7%/23.9%/16%）、健康（8.80%→25.40%/2016拐点）、劳动（91.3%/84.8%/54.4%/32.6%）、休闲（90.8%/68.3%/34.7%/31.8%/18.4%）
- [ ] 翻译三篇关键词默写：海里厄特（`contrary to / have a go at / earn... the hard way`）、农贸市场（`burst with / cut out the middleman / secure profit`）、谈话停顿（`dip / connected / reflection and expression`）
- [ ] 每篇翻译重翻1个最难的句子
...
To be specific, ______ accounts for the largest proportion at ______%, followed by ______.
These years witnessed an uninterrupted rise from ______ to ______.
Notably, the year ______ marked a watershed when ______.
In contrast, ______ occupy smaller shares: ______ respectively.
...
As far as I am concerned, it is a positive trend ______.
```

## 二、阅读错题整理（30分钟）

- [ ] 统计 Day26—Day31 的错题类型：细节 / 推理 / 例证 / 主旨 / 态度 / 词汇
- [ ] 对比 Day05—Day32 五周错题：哪类题错得最多，考前重点练哪类
- [ ] 把最常错的10个词整理到错词本
- [ ] 2024—2025八篇定位句各抄1个，标出同义替换

> [!NOTE]- Day32 复盘检查（做完再点开）
> **大作文检查：**
> 1. 模板骨架0错，五套数据数字不错、顺序不错。
> 2. 四数据句 `while only a minority...`、五数据句 `In contrast... respectively` 0错。
>
> **翻译检查：**
> - 三篇关键词无漏翻，长句先划主干再补修饰。
>
> **阅读检查：**
> - 2024—2025均使用英语（二）真题；不要用普通英语阅读或自编文章替代。
> - 每篇只需完成：限时做题 → 对答案 → 记录定位句 → 整理核心词。

## 本周完成标准

- [ ] 大作文模板+五套数据能默
- [ ] 3篇翻译（海里厄特/农贸市场/谈话停顿）完成并订正
- [ ] 6篇阅读全部完成并订正
- [ ] 更新“阅读错题类型”清单（五周对比）
